//todo esto es de fetching de datos en TypeScript
//y validacion de datos con zod
//con la erramienta de quicktype.io
...
const data = GitHubApiResponseSchema.parse(json)



//si hago esto me va a aprecer todo tipado
